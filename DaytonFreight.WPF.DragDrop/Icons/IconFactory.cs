...
namespace DaytonFreight.WPF.DragDrop.Icons
{
    /// <summary>
    ...
    public static class IconFactory
    {
        ...
        {
            var uri = new Uri($@"pack://application:,,,/DaytonFreight.WPF.DragDrop;component/Icons/{iconName}", UriKind.RelativeOrAbsolute);
